...
public class SteelIngot extends Item {
    ...
    public void appendHoverText(
        ...
        if (Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("item.steel.tooltip"));
            tooltipComponents.add(Component.translatable("item.steel.tooltip1").withStyle(ChatFormatting.GRAY));
        } else {
