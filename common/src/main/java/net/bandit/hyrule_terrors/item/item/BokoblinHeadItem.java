...
public class BokoblinHeadItem extends StandingAndWallBlockItem {

    public BokoblinHeadItem(Block standing, Block wall, Properties props) {
        super(standing, wall, props, Direction.DOWN);
    }
