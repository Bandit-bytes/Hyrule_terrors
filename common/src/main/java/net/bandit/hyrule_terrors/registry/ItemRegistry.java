...
public class ItemRegistry {
    ...
    public static final RegistrySupplier<Item> BOKOBLIN_ARM = ITEMS.register("bokoblin_arm",
            () -> new BokoblinArm(Tiers.IRON, new Item.Properties().attributes(SwordItem.createAttributes(Tiers.STONE, 2, -1.5F)).rarity(Rarity.RARE).durability(75).arch$tab(TabRegistry.HYRULE_TERRORS_TAB)));
    public static final RegistrySupplier<Item> SILVER_LONGSWORD = ITEMS.register("silver_longsword",
            () -> new SilverLongsword(Tiers.IRON, new Item.Properties().attributes(SwordItem.createAttributes(Tiers.DIAMOND, 4, -2.5F)).rarity(Rarity.RARE).durability(250).arch$tab(TabRegistry.HYRULE_TERRORS_TAB)));
    ...
    public static final RegistrySupplier<Item> BOULDER_BREAKER = ITEMS.register("boulder_breaker",
            () -> new BoulderBreaker(Tiers.IRON, new Item.Properties().attributes(SwordItem.createAttributes(Tiers.NETHERITE, 9, -3.5F)).rarity(Rarity.EPIC).durability(475).arch$tab(TabRegistry.HYRULE_TERRORS_TAB)));
