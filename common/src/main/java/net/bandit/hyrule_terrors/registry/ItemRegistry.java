...
public class ItemRegistry {
    ...
    public static final RegistrySupplier<Item> YELLOW_CHUCHU_SPAWN_EGG = ITEMS.register(
        "yellow_chuchu_spawn_egg",
        () -> new ArchitecturySpawnEggItem(
    ...
    public static final RegistrySupplier<Item> CHUCHU_JELLY_YELLOW = ITEMS.register(
        "chuchu_jelly_yellow",
        () -> new ChuchuJellyYellow(
            new Item.Properties().arch$tab(TabRegistry.HYRULE_TERRORS_TAB).rarity(Rarity.UNCOMMON)
        )
    );
    // ARMOR
    ...
    public static final RegistrySupplier<Item> ZORA_HELMET = ITEMS.register(
        ...
        () -> new ZoraArmorItem(
            ...
            armorProps(ArmorItem.Type.HELMET, DIAMOND_DURABILITY, Rarity.RARE)
        )
    );
    ...
    public static final RegistrySupplier<Item> ZORA_CHESTPLATE = ITEMS.register(
        ...
        () -> new ZoraArmorItem(
            ...
            armorProps(ArmorItem.Type.CHESTPLATE, DIAMOND_DURABILITY, Rarity.RARE)
        )
    );
    ...
    public static final RegistrySupplier<Item> ZORA_LEGGINGS = ITEMS.register(
        ...
        () -> new ZoraArmorItem(
            ...
            armorProps(ArmorItem.Type.LEGGINGS, DIAMOND_DURABILITY, Rarity.RARE)
        )
    );
    ...
    public static final RegistrySupplier<Item> BARBARIAN_BOOTS = ITEMS.register(
        ...
        () -> new BarbarianArmorItem(
            ...
            armorProps(ArmorItem.Type.BOOTS, DIAMOND_DURABILITY, Rarity.RARE)
        )
    );
    ...
    public static final RegistrySupplier<Item> EVIL_SPIRIT_HELMET = ITEMS.register(
        "evil_spirit_helmet",
        () -> new EvilSpiritArmorItem(
            ArmorItem.Type.HELMET,
            armorProps(ArmorItem.Type.HELMET, NETHERITE_DURABILITY, Rarity.EPIC)
        )
    );
    ...
    public static final RegistrySupplier<Item> EVIL_SPIRIT_CHESTPLATE = ITEMS.register(
        ...
        () -> new EvilSpiritArmorItem(
            ArmorItem.Type.CHESTPLATE,
            armorProps(ArmorItem.Type.CHESTPLATE, NETHERITE_DURABILITY, Rarity.EPIC)
        )
    );
    ...
    public static final RegistrySupplier<Item> EVIL_SPIRIT_LEGGINGS = ITEMS.register(
        ...
        () -> new EvilSpiritArmorItem(
            ArmorItem.Type.LEGGINGS,
            armorProps(ArmorItem.Type.LEGGINGS, NETHERITE_DURABILITY, Rarity.EPIC)
        )
    );
    ...
    public static final RegistrySupplier<Item> EVIL_SPIRIT_BOOTS = ITEMS.register(
        ...
        () -> new EvilSpiritArmorItem(
            ArmorItem.Type.BOOTS,
            armorProps(ArmorItem.Type.BOOTS, NETHERITE_DURABILITY, Rarity.EPIC)
        )
    );
